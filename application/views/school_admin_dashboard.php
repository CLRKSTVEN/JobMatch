...
<head>
  ...
  <style>
    :root{--ink:#0f172a;--muted:#6b7280;--line:#e5e7eb;--primary:#2563eb;--primary-700:#1e3a8a;--card:#fff;--hover:rgba(2,6,23,.03);--gold:#fbbf24;--silver:#d1d5db}
    ...
    .kpi .ico{width:42px;height:42px;border-radius:12px;display:inline-flex;align-items:center;justify-content:center;background:#eff6ff;color:#2563eb}
    .kpi .ico.gold{background:rgba(251,191,36,.18);color:#b45309}
    .kpi .ico.silver{background:rgba(209,213,219,.35);color:#374151}
      ...
      <div class="content-wrapper pb-0">
        <div class="px-4 md:px-8 max-w-7xl mx-auto">
          ...
          <section class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div class="card p-5 kpi"><div class="ico gold"><i class="mdi mdi-account-group"></i></div><div><div class="text-sm muted">Total Users</div><div class="val"><?= number_format($total) ?></div></div></div>
            <div class="card p-5 kpi"><div class="ico"><i class="mdi mdi-check-circle-outline"></i></div><div><div class="text-sm muted">Active</div><div class="val"><?= number_format($activeC) ?></div></div></div>
            <div class="card p-5 kpi"><div class="ico silver"><i class="mdi mdi-minus-circle-outline"></i></div><div><div class="text-sm muted">Inactive</div><div class="val"><?= number_format($inactC) ?></div></div></div>
          </section>
            ...
            <div class="card p-5">
              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <?php endforeach; else: ?>
                    <tr><td colspan="5" class="text-center muted">No data.</td></tr>
                  <?php endif; ?>
                  </tbody>
                </table>
              </div>
