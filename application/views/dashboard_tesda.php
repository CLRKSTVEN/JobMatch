...
<head>
  ...
  <style>
    ...
    .app{max-width:1050px;margin:0 auto;padding:0 16px}

    .hero{
      position:relative;border-radius:16px;color:#fff;padding:16px;
      background:linear-gradient(135deg,var(--brand-blue) 0%,var(--brand-blue-dark) 60%);
      box-shadow:var(--shadow);display:flex;align-items:center;gap:12px
    }
    .hero .ico{width:44px;height:44px;border-radius:10px;display:grid;place-items:center;background:rgba(255,255,255,.14); border:1px solid rgba(255,255,255,.2)}
    ...
    .kpi{
      background:var(--card); border:1px solid #e7ebf2; border-radius:var(--radius); 
      box-shadow:var(--shadow); padding:14px; display:flex; align-items:center; justify-content:space-between
    }
    ...
    .panel{
      background:#fff;border:1px solid #e7ebf2;border-radius:var(--radius);
      box-shadow:var(--shadow); padding:16px
    }
    .panel h6{margin:0 0 10px;font-size:1rem;font-weight:800}
    .actions{display:flex;flex-wrap:wrap;gap:10px}
    .btn{display:inline-flex;align-items:center;gap:.5rem;padding:.6rem .95rem;border-radius:10px;font-weight:800;text-decoration:none}
    .btn-blue{background:var(--brand-blue);border:1px solid var(--brand-blue);color:#fff}
    .btn-silver{background:#fff;border:1px solid var(--brand-silver);color:var(--brand-ink)}
