...
<head>
  ...
  @media (max-width: 768px) {
    ...
    .profile-cover{ height:96px; background-size:cover !important; }
    .profile-main{
    ...
    .profile-main .badges{ grid-column: 1 / -1; }
    .avatar{ width:64px; height:64px; margin-top:-44px; border-width:3px; }

    .profile-name{ font-size: var(--fs-title); }
    .profile-sub{ font-size: 12px; }
    .meta{ font-size: 12px; }
    .btn-primary-brand{ width: 100%; justify-content: center; }
    .panel{ border-radius:16px; padding: var(--pad-panel); }
    .panel + .panel{ margin-top: 10px; }
    .kpi-grid{ gap: 10px; }
    .kpi .icon{ width:32px; height:32px; border-radius:8px; }
    .c-card{ height: 120px; }
    .c-overlay{ padding:10px; }
    .c-tag{ font-size: 11.5px; padding:.35rem .7rem; }
  ...
  @media (max-width: 768px){
    ...
    .panel .table tbody tr td:not([data-th])::before { content: none; }
    ...
    .panel .table tbody tr{ padding: 12px; }
  }
  @media (max-width:768px){
  .panel .btn-primary-brand{ width:100%; justify-content:center; }
}
...
<div class="c-grid certs-row" style="margin-top:6px">
  ...
  (function () {
    ...
    var obs = new MutationObserver(function(){ applyLabels(tbl); });
    if (tbl.tBodies && tbl.tBodies[0]) {
      obs.observe(tbl.tBodies[0], { childList: true, subtree: true });
    }
  })();
</script>
