  ...
  <link rel="shortcut icon" href="<?= base_url('assets/images/logo-small.png'); ?>" />
    ...
    *{ box-sizing:border-box; }
    ...
    @media (min-width: 920px){
      .job-card{flex-direction:row;align-items:stretch;}
    }
    .job-card__media{
      flex:0 0 auto;
      width:100%;
    ...
    @media (max-width: 919px){
      .job-card__media{max-width:100%;height:220px;}
      .job-card__media img{height:100%;}
    }
    .job-card__content{
      flex:1;
      display:flex;
...
<header class="landing-header" id="home">
  <div class="landing-container nav-container">
    <a href="<?= site_url(); ?>" class="brand">
      <img src="<?= base_url('assets/images/logo.png'); ?>" alt="TrabaWHO logo">
    ...
    <nav class="nav-links">
      ...
      <a href="#why-choose">Why TrabaWHO?</a>
...
<main>
  ...
  <section class="landing-stats" id="why-choose">
    <div class="landing-container">
      <h2 class="section-head">Community impact across TrabaWHO</h2>
    ...
    <div class="landing-container">
      <div class="toolkit-shell" data-default-role="<?= htmlspecialchars($toolkitDefault, ENT_QUOTES, 'UTF-8'); ?>">
        <div>
          ...
          <p class="section-subhead">Switch tabs to discover the workflows available to you inside TrabaWHO.</p>
        </div>
  ...
  <section class="landing-features" id="services">
    <div class="landing-container">
      ...
      <p class="section-subhead">Whether you are a worker, employer, or school partner, TrabaWHO keeps everyone in sync.</p>
  ...
  <section class="landing-journey" id="how-it-works">
    <div class="landing-container">
      <h2 class="section-head">How your TrabaWHO journey works</h2>
  ...
  <section class="landing-cta" id="get-started">
    <div class="landing-container">
      <div class="cta-shell">
        ...
        <?php else: ?>
          <h2>Start your next opportunity with TrabaWHO</h2>
  ...
  <div class="landing-container">
    <div class="footer-grid">
      ...
      <div>
        ...
        <div class="footer-links">
          <span>Email <a href="mailto:support@trabawho.ph">support@trabawho.ph</a></span>
    ...
    <div class="footer-meta">
      <span>&copy; <?= date('Y'); ?> TrabaWHO - City of Mati </span>
