<?php defined('BASEPATH') OR exit('No direct script access allowed'); $page_title = 'Report a Scam'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    .btn-brand{background:#f5f8ff;border:1px solid var(--brand);color:var(--ink);border-radius:12px;font-weight:700;padding:.5rem .95rem}
