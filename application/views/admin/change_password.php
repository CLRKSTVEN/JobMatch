...
<head>
  ...
  <style>
    ...
    .hero{
      ...
      box-shadow:var(--shadow); overflow:hidden; display:flex; align-items:center; gap:12px;
    }
    .hero:after{
    ...
    .hero h4{margin:0;font-weight:700;letter-spacing:.2px}
    .hero .sub{opacity:.95;font-size:.92rem}

    /* Card */
    .card{
      background:var(--card); border-radius:16px; box-shadow:var(--shadow); padding:20px;
    ...
    /* Inputs */
    .form-control{
      border:1px solid #0b1220; border-radius:12px; padding:.85rem .95rem; font-weight:500;
      transition:border-color .18s ease, box-shadow .18s ease;
    }
    .form-control:focus{outline:0;border-color:var(--blue-3);box-shadow:0 0 0 3px rgba(43,77,165,.18)}
    .muted{color:var(--muted);font-size:.9rem}
    .chips{display:flex;flex-wrap:wrap;gap:.45rem;margin-top:10px}
    .chip{display:inline-flex;align-items:center;gap:.35rem;padding:.3rem .6rem;border-radius:9999px;
      border:1px solid var(--silver-2);background:#fff;font-size:.85rem}
    ...
    .btn-gold{background:var(--gold);border:1px solid var(--gold);color:#111827}
