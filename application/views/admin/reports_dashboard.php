    ...
    <style>
        ...
        --gold-700:#b45309; --gold-600:#fbbf24;
        --silver-600:#a7afba; --silver-500:#c0c6d0; --silver-300:#d9dee7; --silver-200:#e7ebf2; --silver-100:#f6f8fc;
        --radius:12px; --pad-panel:12px; --fs-body:13px; --fs-kpi:18px; --fs-kpi-label:12px; --shadow-1:0 6px 16px rgba(2,6,23,.08);
        }
        ...
        .pill-ok{background:rgba(37,99,235,.12);color:#2563eb;border:1px solid rgba(37,99,235,.32)}
        .pill-warn{background:rgba(251,191,36,.18);color:#92400e;border:1px solid rgba(251,191,36,.4)}
        ...
        .table-r tbody tr{
            display:block; padding:10px; border:1px solid var(--silver-300);
            border-radius:12px; background:#fff; box-shadow:var(--shadow-1);
        }
        .table-r tbody tr + tr{margin-top:8px}
        .table-r td{
            display:grid; grid-template-columns:110px 1fr; gap:8px; padding:6px 0 !important; border:0 !important; font-size:12.5px;
        }
        ...
        <i class="mdi mdi-printer"></i> Print
            ...
            <div class="kpi-grid">
                ...
                <div style="display:flex;align-items:center;gap:10px">
                    <div class="icon" style="background:rgba(37,99,235,.12)"><i class="mdi mdi-briefcase-outline" style="font-size:18px;color:#2563eb"></i></div>
                    <div>
            ...
            <section class="panel panel--wide">
                <div class="panel-head"><i class="mdi mdi-briefcase-outline"></i><h6>All Jobs (including zero applicants)</h6></div>
                ...
                <?php else: ?>
                    ...
                    <table class="table table-sm table-r" style="width:100%">
                        ...
                        <tr>
                            <th>ID</th><th>Title</th><th>Type</th><th>Status</th><th>Created</th><th>Applicants</th>
                        </tr>
                        </thead>
                        <tbody>
            ...
            <section class="panel panel--wide">
                <div class="panel-head"><i class="mdi mdi-account-multiple-check"></i><h6>Jobs That Received Applicants</h6></div>
                <div class="panel-body">
                ...
                <?php else: ?>
                    ...
                    <table class="table table-sm table-r" style="width:100%">
                        <thead class="bg-light">
                        <tr>
                            <th>ID</th><th>Title</th><th>Type</th><th>Status</th><th>Applicants</th><th>First Applied</th><th>Last Applied</th>
                        </tr>
                        </thead>
                        <tbody>
            ...
            <section class="panel panel--wide">
                <div class="panel-head"><i class="mdi mdi-account-tie-outline"></i><h6>Employers / Clients - Projects Summary</h6></div>
                <div class="panel-body">
                ...
                <?php else: ?>
                    ...
                    <table class="table table-sm table-r" style="width:100%">
                        <thead class="bg-light">
                        <tr>
                            <th>Client</th><th>Total Projects</th><th>With Applicants</th><th>Action</th>
                        </tr>
                        </thead>
                        <tbody>
