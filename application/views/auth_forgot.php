...
<head>
  ...
  <style>
    :root{
      ...
      --silver-500:#c0c6d0; --silver-300:#d9dee7; --silver-200:#e7ebf2; --silver-100:#f6f8fc;
      --radius:16px;
    ...
    *{box-sizing:border-box}
    ...
    .card{
      width:100%;max-width:720px;background:#fff;border:1px solid var(--silver-300);
    ...
    .card-head h1{font-size:22px;line-height:1.1;margin:0;font-weight:700}
    ...
    .input{
      width:100%;padding:12px 14px;border:1px solid var(--silver-300);border-radius:12px;
    ...
    .alert{
      border-radius:10px;padding:10px 12px;margin-bottom:12px;font-size:13px;font-weight:600
    }
