<?php defined('BASEPATH') OR exit('No direct script access allowed'); $page_title = 'Complaint #'.(int)($item->id ?? 0); ?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    :root{--ink:#1e3a8a; --brand:#2563eb; --muted:#64748b; --line:#d9dee7; --chip:#eef2ff; --radius:14px; --shadow:0 8px 22px rgba(2,6,23,.10)}
    body{background:linear-gradient(180deg,#f6f8fc,#eef2f7 70%,#e9edf3)}
    ...
    .eyebrow{font-weight:700;color:#1f2937;margin-bottom:10px}
    .panel{background:#fff;border:1px solid var(--line);border-radius:var(--radius);box-shadow:var(--shadow);padding:16px}
    .meta{display:flex;flex-wrap:wrap;gap:12px;font-size:13px;color:#334155}
    .meta .item{display:flex;gap:6px;align-items:center;background:#fbfcff;border:1px solid #e5e7eb;border-radius:999px;padding:6px 10px}
    ...
    .st-open{background:#f59e0b}
    .st-under{background:#1e3a8a}
    .st-resolved{background:#fbbf24}
    .st-dismissed{background:#94a3b8}
