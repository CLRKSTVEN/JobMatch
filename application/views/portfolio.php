...
<head>
  ...
  <style>
    ...
    .btn{display:inline-flex;align-items:center;gap:.5rem;padding:.5rem .9rem;border-radius:10px;font-weight:600;font-size:.9rem;transition:all .18s ease}
    ...
    .card-flat{background:var(--card);border:1px solid var(--indigo-200);border-radius:14px;
      box-shadow:var(--shadow-1);transition:transform .16s ease,box-shadow .18s ease,border-color .18s ease}
    .card-flat:hover{transform:translateY(-2px);box-shadow:var(--shadow-2);border-color:var(--indigo-400)}

    .stat{display:flex;align-items:center;gap:.75rem;padding:14px}
    .stat .icon{font-size:22px;opacity:.9}
    .stat .label{color:var(--muted);font-size:.85rem}
    .stat .val{font-weight:700;font-size:1.25rem;color:var(--ink)}
    ...
    .p-cover{
      position:relative;height:160px;background:#f8fafc;display:flex;align-items:center;justify-content:center;
    ...
    .p-overlay{
      position:absolute;inset:0;display:flex;align-items:flex-end;justify-content:center;padding:14px;
      background:linear-gradient(to top, rgba(15,23,42,.55), rgba(15,23,42,.15) 45%, rgba(15,23,42,0));
      color:#fff;text-decoration:none;font-weight:700;gap:.5rem;opacity:0;transform:translateY(6px);
      transition:opacity .18s ease, transform .18s ease
    }
    .p-overlay .tag{display:inline-flex;align-items:center;gap:.4rem;padding:.35rem .6rem;border-radius:9999px;
      background:rgba(255,255,255,.12);backdrop-filter:saturate(140%);font-weight:700}
    .p-overlay .more{font-style:normal;font-weight:600;opacity:.9;margin-left:.25rem;background:rgba(255,255,255,.18);
      padding:.05rem .4rem;border-radius:9999px;font-size:.8rem}
    .p-card:hover .p-overlay{opacity:1;transform:translateY(0)}
    .p-overlay:focus{outline:2px solid #fff;outline-offset:-2px;opacity:1}
    ...
    .badge-soft{display:inline-flex;align-items:center;border-radius:9999px;padding:.2rem .55rem;font-weight:600;font-size:.8rem;
      border:1px solid var(--indigo-200);background:#eef2ff;color:#3730a3;transition:all .18s ease}
    ...
    .chip{display:inline-flex;align-items:center;gap:6px;padding:.28rem .6rem;border-radius:9999px;border:1px solid var(--line);background:#fff;
      font-size:.8rem;color:#334155;text-decoration:none;transition:all .18s ease;box-shadow:0 2px 6px rgba(2,6,23,.06)}
...
.table thead.bg-light th { border-bottom: 1px solid var(--line); }
      ...
      <div class="main-panel">
        <div class="content-wrapper pb-0">
          <div class="app">
            ...
            <div class="mb-3"><div class="eyebrow"><?= htmlspecialchars($page_title ?? 'Dashboard', ENT_QUOTES, 'UTF-8') ?></div></div>
              ...
              <div class="row g-3 mb-3">
                <div class="col-md-4">
                  <div class="card-flat stat">
                    ...
                    <div><div class="label">Times Hired</div><div class="val"><?= (int)$times_hired ?></div></div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="card-flat stat">
                    ...
                    <div>
                      ...
                      <span class="meta">
                        <?php $avg=(float)($reviews['avg'] ?? 0); for($i=1;$i<=5;$i++){ echo '<i class="mdi mdi-star'.($avg>=$i?'':'-outline').' text-warning"></i>'; } ?>
                      </span>
                ...
                <div class="col-md-4">
                  <div class="card-flat stat">
                    ...
                    <div><div class="label">Portfolio Items</div><div class="val"><?= is_array($items??[])?count($items):0 ?></div></div>
                  </div>
                </div>
              </div>
