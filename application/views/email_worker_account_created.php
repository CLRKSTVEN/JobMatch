...
<head>
  <meta charset="utf-8">
  <title>Welcome to TrabaWHO</title>
  <style>
    body{background:#f3f5f7;margin:0;padding:24px;font-family:Arial,Helvetica,sans-serif;color:#111;}
    .card{max-width:620px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:12px;box-shadow:0 6px 18px rgba(16,24,40,.08);}
    .pad{padding:24px;}
    .muted{color:#6b7280;font-size:13px}
    .bar{height:3px;background:#ffd200;width:56px;border-radius:2px;margin:6px 0 16px}
  </style>
</head>
<body>
  <div class="card">
    ...
    <div class="pad">
      ...
      <?php if (!empty($logoSrc)): ?>
        <div style="margin-top:18px;display:flex;align-items:center;gap:8px;">
          ...
          <span class="muted">City of Mati • TrabaWHO</span>
        </div>
      <?php endif; ?>
    </div>
  </div>
