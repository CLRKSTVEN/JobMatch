...
<head>
  ...
  <style>
    ...
    .h-card{border:1px solid var(--silver-300);border-radius:12px;padding:12px;box-shadow:var(--shadow-1);background:#fff;height:100%}
    .h-title{font-weight:800;color:var(--blue-900);margin:0}
    .h-sub{color:#6b7280;font-size:12px}
    .h-phone code{font-size:14px}
  </style>
</head>
<body>
