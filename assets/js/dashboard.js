(function ($) {
  ...
  if ($("#performanceChart").length) {
    ...
    var performanceOptions = {
      ...
      plugins: {
        ...
        tooltip: {
          backgroundColor: "#dbdfe3",
          enabled: true  // Explicitly enabling tooltips (default in v4)
        }
      },
      elements: {
        point: {
          radius: 0,
          hoverRadius: 0  // Explicitly setting hover state
        },
        line: {
          tension: 0,
          borderWidth: 2  // Added for better visibility
        }
      }
    };
    ...
    var performanceAreaChartOptions = {
      ...
      elements: {
        ...
        line: {
          tension: 0,
          borderWidth: 2,
          fill: true  // Important for area charts
        }
      }
    };
    ...
    const taskAreaChartOptions = {
      ...
      elements: {
        ...
        line: {
          tension: 0,
          borderWidth: 2,
          fill: 'origin' // Proper area chart filling
        }
      },
      interaction: {
        mode: 'index',
  ...
  $(function () {
    ...
    $.plot("#flotChart", [
      ...
      grid: {
        color: "#aab2bd",      // Main grid line color
        tickColor: "#aab2bd",
        borderWidth: 0,
        labelMargin: 8,
      },
      xaxis: {
        ...
        tickColor: "#939393",
        ticks: [
          [0, "Jan"], [10, "Feb"], [20, "Mar"], [30, "Apr"],
          [40, "May"], [50, "Jun"], [60, "Jul"], [70, "Aug"],
          [80, "Sep"], [90, "Oct"]
        ],
        tickLength: 0,
      },
      yaxis: {
        ...
        ticks: [
          [0, "0"], [20, "$100"], [40, "$1200"], [60, "$300"], [80, "$400"]
        ],
      },
    });
  });
